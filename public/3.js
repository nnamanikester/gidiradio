...
var render = function() {
  ...
  return _c("div", { staticClass: "search-result" }, [
      ...
      ? _c("div", { staticClass: "found" }, [
          ...
          _c("div", { staticClass: "blogs" }, [
            ...
            _c("div", { staticClass: "container" }, [
              _c("div", { staticClass: "block-loop-row" }, [
                _c(
                  "article",
                  {
                    staticClass:
                      "block-loop-item station type-station status-publish has-post-thumbnail hentry entry"
                  },
                  [
                    _vm._m(4),
                    _vm._v(" "),
    ...
    _vm._v(" "),
    !_vm.found
      ? _c("article", { staticClass: "no-results not-found" }, [
          _vm._m(9),
          _vm._v(" "),
          _vm._m(10)
        ])
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "container" }, [_c("Advert")], 1)
  ])
}
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "container clear" }, [
                ...
                [
                  _c("img", {
                    ...
                    attrs: {
                      ...
                      height: "573",
                      src:
                        "http://flatfull.com/wp/bepop/wp-content/uploads/2019/06/c3.jpg",
                      alt: "",
            ...
            _c("header", { staticClass: "entry-header" }, [
              _c("h3", { staticClass: "entry-title" }, [
                _c(
                  ...
                  {
                    attrs: {
                      href: "http://flatfull.com/wp/bepop/station/aaaa/",
                      rel: "bookmark"
                    }
                  },
                  [_vm._v("aaaa")]
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "programmes" }, [
      _c("div", { staticClass: "container clear" }, [
        _c("h1", { staticClass: "page-title" }, [_vm._v("Programmes: ")])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "block-loop-row" }, [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "container clear" }, [
      _c("h1", { staticClass: "page-title" }, [_vm._v("Blogs: ")])
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h3", { staticClass: "entry-title" }, [
      _c(
        "a",
        {
          attrs: {
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { staticClass: "svg-icon" }, [
      _c("img", {
        staticClass: "avatar avatar-48 photo",
        attrs: { alt: "", src: "", height: "48", width: "48" }
      })
    ])
  },
  function() {
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("header", { staticClass: "entry-header" }, [
      _c("h1", [_vm._v("Nothing Found")])
    ])
  },
  function() {
    var _vm = this
